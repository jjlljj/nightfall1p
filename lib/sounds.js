...
const sounds = {
  ...
  soundTrack: {
    ...
    level1: () => {
      ...
      soundTrack = new Audio('../assets/audio-assets/level1song.mp3')
      soundTrack.loop = true
      soundTrack.play()
    },
    level2: () => {
      ...
      soundTrack = new Audio('../assets/audio-assets/level2song.mp3')
      soundTrack.loop = true
      soundTrack.play()
    },
    level3: () => {
      ...
      soundTrack = new Audio('../assets/audio-assets/level3song.mp3')
      soundTrack.loop = true
      soundTrack.play()
    },
