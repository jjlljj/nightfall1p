...
class Game {
  ...
  gameOverScreen() {
    ...
    this.ctx.font = "bold 70pt arcadeclassicregular";
    this.ctx.textAlign = 'center';
    this.ctx.fillText('Game Over', 500, 250);
    this.ctx.font = "italic bold 40pt arcadeclassicregular";
    if (this.player1.lives === 0) {
      this.ctx.fillText('Player 2 Wins!', 500, 420);
    } else {
      this.ctx.fillText('Player 1 Wins!', 500, 420);
    }
    this.ctx.font = 'italic 20pt arcadeclassicregular'
  ...
  instructions() {
    ...
    this.ctx.font = "bold 16pt arcadeclassicregular";
    this.ctx.textAlign = 'center';
  ...
  displayControls() {
    ...
    image.src = '../assets/p2-controls.png'
    ...
    this.ctx.drawImage(image, 30, 150)
