...
<<<<<<< HEAD
    ...
    this.player1 = new Player(this.ctx, 175, 100, this.background.platforms, this.keyboarder, 'player1');
    this.player2 = new Player(this.ctx, 785, 100, this.background.platforms, this.keyboarder, 'player2');
=======
