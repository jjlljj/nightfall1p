...
class Game {
  constructor() {
    ...
    setTimeout(() => background.drawBackground(), 400); 
    let player1 = new Player1(ctx, 150, canvas.height/3, background.platforms, keyboarder);
    let player2 = new Player2(ctx, canvas.width - 200, canvas.height/3, background.platforms, keyboarder);
