...
class Game {
  ...
  versus() {
    ...
    this.enemies.push(new Eye(this.ctx, this.player1, this.player2));
    this.enemies.push(new Eye(this.ctx, this.player1, this.player2));
    this.enemies.push(new Eye(this.ctx, this.player1, this.player2));
    this.enemies.push(new Eye(this.ctx, this.player1, this.player2));
  }
  ...
  coop() {
    const bossAppearance = 3000; //3 sec
  ...
  eyePortal() {
    if(this.canUsePortal) {
      ...
      const height = 100;
      const width = 100;
      this.ctx.fillRect(randomX - width/2, randomY - height/2, width, height);
      setTimeout(() => {
